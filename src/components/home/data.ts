...
export const mobileNavItems = [
  ...
  { title: "In-Play", icon: "▶️" },
  { title: "All Market Book", icon: "📊" },
  { title: "Profile", icon: "👤" },
  { title: "Password", icon: "🔑" },
  { title: "Rules", icon: "📜" },
  { title: "My Commission", icon: "📘" },
  { title: "Report", icon: "📗", action: "+" },
  { title: "Live Games", icon: "🎮" },
  { title: "Edit Stake", icon: "📗" },
];

export const cricketMatches = [
  { opponent: "Bangladesh v Ireland", time: "19 Nov 09:00" },
  { opponent: "Bangladesh A v Sri Lanka A", time: "19 Nov 20:00" },
